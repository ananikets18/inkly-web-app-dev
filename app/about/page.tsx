          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              <p className="text-lg sm:text-xl leading-relaxed">
                Inkly was born from a simple belief: everyone has a story worth telling, and every thought deserves a
                beautiful canvas. In a world filled with noise, we wanted to create a space where creativity could
                flourish, where words could find their perfect form, and where meaningful connections could grow through
                shared expression.
              </p>

              <p className="text-lg sm:text-xl leading-relaxed">
                We noticed that traditional social platforms often prioritize quantity over quality, speed over
                reflection. Inkly is different. Here, we celebrate the art of thoughtful expression, whether it's a
                profound poem, a daily reflection, or a moment of inspiration that deserves to be preserved and shared.
              </p>

              <p className="text-lg sm:text-xl leading-relaxed">
                Our platform combines the visual appeal of modern design with the timeless power of written word,
                creating an environment where creators can focus on what matters most: authentic self-expression and
          ...
          <div className="max-w-5xl mx-auto text-center">
            ...
            >
              ...
              <div className="space-y-8 text-muted-foreground">
                <p className="text-lg sm:text-xl leading-relaxed">
                  At Inkly, we believe in the transformative power of positive creative expression. Our community is
                  built on principles of respect, authenticity, and mutual inspiration. We're not just a platform—we're
                  a movement toward more meaningful digital interaction.
                </p>
                <p className="text-lg sm:text-xl leading-relaxed">
                  Our vision is to create a world where every voice is heard, every story is valued, and every creative
                  spark has the potential to ignite something beautiful in others. Join us in building a more
                  thoughtful, creative, and connected digital future.
                </p>
              </div>
            </motion.div>
          </div>
        ...
        >
          <div className="max-w-7xl mx-auto">
            ...
            <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
                  <p className="text-lg">&copy;2025 | Made with ❤️ by the Inkly team. </p>
            </div>
          </div>
        </footer>
